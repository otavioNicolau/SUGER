...
<!-- Page Heading -->
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header texto">{{Session::get('nome')}} <small> ATUALIZAR HABILITAÇÃO</small></h1>
        </div>
    </div>
    <!-- /.row -->
...
{{ Form::model($habilitaco, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('habilitacos.update', $habilitaco->id))) }}
        ...
        <div class="panel-body">
            <div class="form-group">      
                <div class="col-sm-offset-4  col-sm-12">
                    ...
                    {{ link_to_route('habilitacos.show', 'CANCELAR', $habilitaco->id, array('class' => 'btn btn-lg btn-danger')) }}
               </div>
