...
{{ Form::open(array('route' => 'escolaridades.store', 'class' => 'form-horizontal')) }}
...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        {{ Form::hidden('func_dados', Session::get('id'), array('class'=>'form-control')) }}
    ...
    <div class="panel-body">
        <div class="form-group">
            <div class="col-sm-offset-4  col-sm-12">
                ...
                {{ link_to_route('escolaridades.show', 'CANCELAR',Session::get('id'), array('class' => 'btn btn-lg btn-danger')) }}
            </div>
        </div>
    </div>
</div>
